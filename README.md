> This repo is a modified clone of [Huang et al. 2021](https://github.com/huangwl18/geometry-dex).

# Shadow Hand Dexterous Manipulation

Shadow Hand is a suite of dexterous manipulation environments with 114 diverse real-world objects built upon [Gym](https://github.com/openai/gym) and [MuJoCo](https://mujoco.org), proposed by "[Generalization in Dexterous Manipulation via Geometry-Aware Multi-Task Learning](https://huangwl18.github.io/geometry-dex/)":
